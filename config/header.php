<div class="header">
    <ul class="header-list">
        ...
        <!-- Form đăng ký sẽ được ẩn ban đầu -->
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-6 m-0">
                                                ...
                                                <input type="tel" class="form-control" id="phone" placeholder="Nhập số điện thoại" maxlength="10">
                                            </div>
                                        </div>
...
<script>
    ...
    // Hiển thị modal khi nhấn vào nút Đăng Ký
    showRegisterButton.addEventListener("click", function() {
        registerModal.style.display = "flex";  // Hiển thị modal
    });

    // Đóng modal khi nhấn bên ngoài modal
    window.addEventListener("click", function(e) {
        if (e.target === registerModal) {
            registerModal.style.display = "none";  // Ẩn modal
        }
    });
</script>