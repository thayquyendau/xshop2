                        ...
                        <div class="detail-main">
                            <form class="form-pay-left" id="paymentForm" action="#" method="post">
                                ...
                                <div class="form-check border border-primary rounded p-3 mb-3 d-flex align-items-center">
                                    ...
                                    <img src="assets\image\logo\logo_bankStranfer.png" alt="Bank Transfer" class="ms-3" width="50" height="40px">
                                </div>
                                ...
                                <div class="form-check border border-primary rounded p-3 mb-3 d-flex align-items-center">
                                    ...
                                    <img src="assets\image\logo\logo_napas.png" alt="Napas" class="ms-3" width="80" height="40px">
                                </div>

                                <div class="form-check border border-primary rounded p-3 mb-3 d-flex align-items-center">
                                    <input type="radio" name="payment" class="check-radio">
                                    <label for="visa" class="count ms-3 form-check-label flex-grow-1">Thẻ quốc tế VISA / Master</label>
                                    <img src="assets\image\logo\logo_visa.png" alt="Visa" class="ms-3" width="40" height="40px">
                                </div>

                                <div class="form-check border border-primary rounded p-3 mb-3 d-flex align-items-center">
                                    <input type="radio" name="payment" class="check-radio">
                                    <label for="shopeepay" class="count ms-3 form-check-label flex-grow-1">Ví điện tử ShopeePay</label>
                                    <img src="assets\image\logo\log_shoppe.png" alt="ShopeePay" class="ms-3" width="40" height="40px">
                                </div>

                                <div class="form-check border border-primary rounded p-3 mb-3 d-flex align-items-center">
                                    <input type="radio" name="payment" class="check-radio">
                                    <label for="zalopay" class="count ms-3 form-check-label flex-grow-1">Ví điện tử ZaloPay</label>
                                    <img src="assets\image\logo\logo_zalo.png" alt="ZaloPay" class="ms-3" width="40" height="40px">
                                </div>
                            </form>
                    ...
                    <div class="step-flex">
                        <div class="detail-main">
                            <div class="step-container">
                                ...
                                <form id="payButton" action="<?= BASE_URL ?>/thanhtoanSuccess" method="POST">
                                    <input type="hidden" value="<?= $_SESSION['cart'] ?>">
